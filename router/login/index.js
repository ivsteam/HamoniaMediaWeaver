...
router.get('/', function(req, res) {
    ...
    res.render('./member/login.ejs', {'message' : msg, 'isLogin' : isLogin});
});
...
router.post('/oauth/hamonikr/callback', passport.authenticate('login-hamonikr', {failureRedirect: '/', failureFlash: true}), 
	function (req, res) {
		res.redirect('/');
	}
);
